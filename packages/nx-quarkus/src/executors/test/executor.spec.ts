...
import { expectExecutorCommandRanWith, GRADLE_WRAPPER_EXECUTABLE, MAVEN_WRAPPER_EXECUTABLE, mockExecutorContext, NX_QUARKUS_PKG } from '@nxrocks/common';
...
const mockContext = mockExecutorContext(NX_QUARKUS_PKG,'test');
